...
{$IFDEF HAS_UNITSCOPE}
  ...
  {$ENDIF MSWINDOWS}
  System.Classes, System.Variants, System.Win.StdVCL,
  {$IFDEF HAS_VCL}
...
{$ELSE ~HAS_UNITSCOPE}
  ...
  Windows, ActiveX,
  {$ENDIF MSWINDOWS}
  Classes, SysUtils, Controls, Variants, Graphics, OleServer
{$ENDIF ~HAS_UNITSCOPE};
...
uses {$IFDEF DELPHIXE2_UP}System.Win.ComObj{$ELSE}ComObj{$ENDIF};
...
begin
  EmptyParam := {$IFDEF DELPHIXE2_UP}System.Variants.{$ENDIF}EmptyParam;
