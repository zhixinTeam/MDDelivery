...
type
  ...
  public
    ...
    procedure WMFrameActive(var nMsg: TMessage); message WM_FrameActive;
  end;
...
procedure TfFrameZTDispatch.Timer1Timer(Sender: TObject);
begin
  inherited;
  BtnRefreshClick(nil);
end;

procedure TfFrameZTDispatch.WMFrameActive(var nMsg: TMessage);
begin
  case nMsg.WParam of
    1:
    begin
