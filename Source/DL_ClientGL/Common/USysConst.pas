...
const
  ...
  cFI_FrameBillRefresh    = $8013;                   //提货查询(实时刷新)
  ...
  cFI_FrameSaletunnelQuery = $8054;                  //发货统计1
  ...
  cFI_FormStockQueue    = $1803;                     //排队信息
  cFI_FormGetStockQueue = $1804;                     //品种排队信息
  ...
  cFI_FrameDayReport_HY = $1120;                     //日报表恒宇建材
...
begin
  ...
  AddMenuModuleItem('MAIN_D16', cFI_FrameBillRefresh);
  AddMenuModuleItem('MAIN_D17', cFI_FormStockQueue, mtForm);
 ...
 // AddMenuModuleItem('MAIN_M14', cFI_FrameYCLStockRecord);
  ...
  AddMenuModuleItem('MAIN_I01', cFI_FormOnLineSet, mtForm);
