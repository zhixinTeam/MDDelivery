...
begin
  ...
  nStr := ' Select L_ID, L_HYDan,(select B_Prefix from S_Batcode where B_Stock = a.L_StockNo) as B_Prefix, '+
          ' (select B_ZMInt from S_Batcode where B_Stock = a.L_StockNo) as B_ZMInt  From %s a Where L_ID = ''%s'' ';
