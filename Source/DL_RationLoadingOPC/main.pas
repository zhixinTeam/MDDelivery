...
uses
  ...
  IniFiles, IdGlobal, UMgrSendCardNo;
...
uses
  UFrame, USysLoger, UClientWorker, UMemDataPool, UFormConn, UMgrdOPCTunnels,
  ...
  begin
    ...
    begin
      ...
      begin
        Width             :=  FWidth;
        Height            :=  FHeight;
        GroupBox1.Width   :=  FWidth -15;
        GroupBox1.Height  :=  FHeight-15;
...
begin
  ...
  FWidth    := MyFile.ReadInteger('FixLoading','Width',303);
  FHeight   := MyFile.ReadInteger('FixLoading','Height',324);
